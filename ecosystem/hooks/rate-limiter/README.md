...
Rate limiting hook factory for burger-api framework. Hook factories are code that runs around your handler — before and/or after it. This hook helps prevent API abuse by limiting the number of requests a client can make within a specified time window.
