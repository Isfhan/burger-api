...
HTTP caching hook factory for burger-api framework. Hook factories are code that runs around your handler — before and/or after it. This hook sets Cache-Control and related headers to control how responses are cached by browsers, CDNs, and proxy servers.
