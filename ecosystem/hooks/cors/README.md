...
Cross-Origin Resource Sharing (CORS) hook factory for burger-api framework.
Hook factories are code that runs around your handler — before and/or after it. This
hook enables your API to be accessible from different origins by setting
