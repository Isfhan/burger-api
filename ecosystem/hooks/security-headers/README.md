...
Security headers hook factory for burger-api framework. Hooks are code that runs around your handler — before and/or after it. This hook factory adds various security-related HTTP headers to protect your application from common web vulnerabilities like XSS, clickjacking, and more.
