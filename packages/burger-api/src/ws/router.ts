...
export class WebSocketRouter {
   ...
   */
  match(path: string): { route: CompiledWebSocketRoute; params: Record<string, string> } | null {
   ...
   */
  private matchParams(pattern: string, path: string): Record<string, string> | null {
   ...
   */
  private matchWildcard(pattern: string, path: string): Record<string, string> | null {
